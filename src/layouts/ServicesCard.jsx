...
const ServicesCard = ({ icon, title }) => {
  return (
    <div className=" group flex flex-col py-10 items-center text-center gap-2 w-full lg:w-1/3 px-5 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg cursor-pointer lg:hover:-translate-y-6 transition duration-300 ease-in-out">
